...
<div class="container bgwhite p-t-35 p-b-80">
	<div class="flex-w flex-sb">
				...
				<div class="slick3">
					<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/thumbs/'.$produk->gambar) ?>">
						<div class="wrap-pic-w">
							<img src="<?php echo base_url('assets/upload/image/'.$produk->gambar) ?>" alt="<?php echo $produk->nama_produk ?>" widht="420" height="520">
						</div>
					</div>
		...
		<div class="w-size14 p-t-30 respon5">
			...
			<span class="m-text14">
			 <?php echo 'Rp. '.number_format($produk->harga,'0',',','.') ?>
			</span>
				...
				<div class="flex-r-m flex-w p-t-10">
					<div class="w-size16 flex-m flex-w">
						...
						<div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
							<!-- Button -->
							<button type="submit" name="submit" value="submit" class="flex-c-m sizefull  btn-info bo-rad-23 hov1 s-text1 trans-0-4">
								Simpan Ke keranjang
							</button>
		...
		<div class="item-slick2 p-l-15 p-r-15">
			...
			<div class="block2">
				<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
					<img src="<?php echo base_url('assets/upload/image/'.$produk_related->gambar) ?>" alt="<?php echo $produk_related->nama_produk ?>" widht="420" height="320">
				...
				<table>
						...
						<td>
								<a href="<?php echo base_url('produk/detail/'.$produk_related->slug_produk) ?>" class="btn btn-info btn-xs">
