<br>
	<?php echo form_open('admin/transaksi/filter');?>
    	...
    	<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						 <div class="btn-group">
		                <a href="<?php echo base_url('admin/transaksi/detail/'.$pembayaran->kode_transaksi) ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> Detail</a>
           				  </div>
					</td>
				</tr>
			</tbody>
