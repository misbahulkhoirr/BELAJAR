...
class MenuController extends Controller
{
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        if ($request->file('image')) {
            ...
            $validateData['image'] = $request->file('image')->store('menus-images'); //setting penyimpanan .env = FILESYSTEM_DRIVER=public lalu cmd php artisan storage: . maka dalam folder public akan ada folder storage blog-images . agar gambar bisa di akses public
        }
