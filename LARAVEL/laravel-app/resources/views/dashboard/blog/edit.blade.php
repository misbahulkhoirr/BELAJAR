      ...
      @csrf
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="kategori_id">
            ...
            @if (old('kategori_id',$kategori->id)==$kategori->id)
        ...
        <div class="mb-3">
          ...
          <input type="hidden" name="imagelama" value="{{ $post->image }}"> {{-- input untuk menghapus img di folder public/blogd-images --}}
          @if ($post->image)
...
<script>
    ...
    title.addEventListener('change',function(){
        fetch('/dashboard/blogs/createSlug?title=' +title.value) //variable blogs sama dengan tabel database
